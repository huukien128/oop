...
public class GameManager extends JPanel implements KeyListener, Runnable, MouseListener {
    ...
    private BufferedImage mainMenuImage; // BIẾN LƯU ẢNG MENU CHÍNH
    ...
    private void resetGameForPlay() {
        ...
        // Bắt đầu Fade In khi vào game lần đầu
        isFadingIn = true;
        fadeAlpha = 0;
    ...
    private void restartCurrentLevel() {
        // --- LOGIC SỬA LỖI CHÍNH TẠI ĐÂY: Reset nhanh chóng ---
        ...
        if (activePowerUp != null) {
            // Loại bỏ hiệu ứng cũ
            // KHÔNG GỌI removeEffect nếu không có bóng để tránh lỗi NullPointerException
